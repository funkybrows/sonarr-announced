...
def get_config_folder_path():
    return os.environ.get(
        "CONFIG_FOLDER_PATH",
        f'{os.path.expanduser("~")}/.{os.environ.get("PROJECT_NAME", "arrnounced")}/config',
    )
...
def get_log_folder_path():
    return os.environ.get(
        "LOG_FOLDER_PATH",
        f'{os.path.expanduser("~")}/.{os.environ.get("PROJECT_NAME", "arrnounced")}/logs',
    )


def get_tracker_folder_path():
    return os.environ.get(
        "TRACKER_FOLDER_PATH",
        f'{os.path.expanduser("~")}/.{os.environ.get("PROJECT_NAME", "arrnounced")}/autodl-trackers',
    )
